        ...
        >
          ...
          <div className="mt-3">
            <motion.button
              ...
              className="w-full flex justify-center items-center px-6 py-3 border-2 border-gray-200 rounded-xl shadow-sm bg-white text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50 transition-all duration-200"
            >
